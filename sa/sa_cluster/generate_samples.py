...
from sensitivity_analysis import (PROBLEM_BASE, PROBLEM_PS, N_SOBOL, RESULTS_DIR, SECOND_ORDER)
...
for model_name, problem in [("BaseModel", PROBLEM_BASE), ("ProductSpaceModel", PROBLEM_PS)]:
    param_values = saltelli.sample(problem, N_SOBOL, calc_second_order=SECOND_ORDER)
